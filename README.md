...
```bash
git clone https://github.com/AlekseiKholin/Data-analytics
<<<<<<< HEAD
cd ETL, report automation
=======
cd sales-etl-pipeline
>>>>>>> 5d8f173e50cd7b723f3c99c283b0c6466300b548
python -m venv venv
...
```bash
# Очистка и загрузка даных в duckDB
python extract_load.py
```
### 3. Запустить Prefect сервер (в отдельном терминале)
```bash
...
├── extract_load.py               # Очистка, загрузка данных в DuckDB
